 ...
 * @author  agr, andrew, leonid
 * @copyright 2005-2007 InfoCentre Ltd.
 * @version 1.0b
 *
 * @link http://phppagination.sourceforge.net/
 */
...
class phpPagination {
    ...
    * @var string $_first
    */
    var $_first = '<a href="__PHP_SELF__?page=__PAGE_NUMBER__">&laquo;</a>';

   /**
    * class variable for template for "last page" (default '>>')
    * @var string $_last
    */
    var $_last = '<a href="__PHP_SELF__?page=__PAGE_NUMBER__">&raquo;</a>';

   /**
    * class variable for template for "previous page" (default '<')
    * @var string $_prev
    */
    var $_prev = '<a href="__PHP_SELF__?page=__PAGE_NUMBER__">&lt;</a>';

   /**
    * class variable for template for "next page" (default '>')
    * @var string $_next
    */
    var $_next = '<a href="__PHP_SELF__?page=__PAGE_NUMBER__">&gt;</a>';
    ...
    * @var string $_page
    */
    var $_page = '<a href="__PHP_SELF__?page=__PAGE_NUMBER__">__PAGE_NUMBER__</a>';
    ...
    */
    ...
    function ic_GeneratePaginationHTML ()
    {
        ...
        $aOutput = split(';', $this->_sPaginationCode);
