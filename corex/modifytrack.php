...
<tr>
    <td> <div align="right"><a class="track" href="addnew.php">Add New Shipment</a> 
        | <a class="track" href="listallmamun.php">List All Active Shipment</a> | <a class="track" href="chngtoken.php">Change 
        Token No.</a> | <a class="track" href="modifytrack.php">Modify Tracking</a> 
        | <a class="track" href="delete.php">Delete Tracking</a><br>
         </div><b>Track No. </b>
      <form action="modifytrack.php" method="Post">
...
<br>
 <form name="deltrac" method="post" action="updatetrack.php">
      <table width="750" align="center">
        <tr> 
...
?>
        <tr bgcolor="#FFFFFF"> 
          ...
          <td><?php echo $row['activity'];?></td>
            <td> <input type="radio" name="seri_id" value="<?php echo $row['serial'];?>"></td>
